...
public class EspressoTestUtil {
    ...
    public static void disableAnimations(
            final ActivityTestRule<? extends FragmentActivity> activityTestRule) {
        activityTestRule.getActivity().getSupportFragmentManager()
                .registerFragmentLifecycleCallbacks(
                        new FragmentManager.FragmentLifecycleCallbacks() {
                            @Override
                            public void onFragmentViewCreated(final FragmentManager fm,
                                                              final Fragment f, final View v,
    ...
    private static void traverseViews(final View view) {
    ...
    private static void traverseViewGroup(final ViewGroup view) {
    ...
    private static void disableRecyclerViewAnimations(final RecyclerView view) {
     ...
     */
    private static void disableProgressBarAnimation(final ProgressBar progressBar) {
